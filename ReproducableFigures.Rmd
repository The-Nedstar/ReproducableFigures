...
#ugly 3d graph
scatter3D(penguins_clean$sample_number, penguins_clean$body_mass_g, penguins_clean$flipper_length_mm, colvar = penguins_clean$flipper_length_mm, col = NULL, pch = 19, cex = 0.5)
